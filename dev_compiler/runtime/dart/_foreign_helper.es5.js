dart_library.library('dart/_foreign_helper', null, ["dart/_runtime", 'dart/core'], [], function(exports, dart, core) {
  'use strict';
  ...
  dart.fn(JS_CURRENT_ISOLATE_CONTEXT, function() {
    return dart.definiteFunctionType(IsolateContext, []);
  });
  var IsolateContext = function($__super) {
    function IsolateContext() {
      $traceurRuntime.superConstructor(IsolateContext).apply(this, arguments);
    }
    return ($traceurRuntime.createClass)(IsolateContext, {}, {}, $__super);
  }(core.Object);
  ...
  var JS_CONST = function($__super) {
    function JS_CONST() {
      $traceurRuntime.superConstructor(JS_CONST).apply(this, arguments);
    }
    return ($traceurRuntime.createClass)(JS_CONST, {JS_CONST: function(code) {
        this.code = code;
      }}, {}, $__super);
  }(core.Object);
  dart.setSignature(JS_CONST, {constructors: function() {
      return ({JS_CONST: [JS_CONST, [core.String]]});
    }});
